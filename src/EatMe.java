...
private void makeAlbum() {
	...
	// this...
	images.put(new Integer(KeyEvent.VK_UP), "ice cream.jpg"); // the spoon will be connected to the UP key
	images.put(new Integer(KeyEvent.VK_LEFT), "sushi.jpg"); // the chopstick will be connected to the LEFT key
	images.put(new Integer(KeyEvent.VK_DOWN), "bob.jpg");
	images.put(new Integer(KeyEvent.VK_RIGHT), "ChocoPudding.jpg");
