...
frame.add(quizPanel);
	...
	// 7. Add the firstButton to the quizPanel
		...
		secondButton= createButton("1,000,000,000");
...
playJeopardyTheme();
	...
	if (buttonPressed== firstButton) {
		askQuestion("Whom is the pop star/rapper that was born on October 24, 1986, in Toronto, Canada?", "Drake",100);
	}	
...
String first=	JOptionPane.showInputDialog(question);
		// If the answer is correct
		if (first.equalsIgnoreCase("Drake")) {
		score+=prizeMoney;
		...
		// Otherwise
			...
			JOptionPane.showMessageDialog(null, " Sorry your wrong..... the right was Drake");
			score-=prizeMoney;
			updateScore();
		}
